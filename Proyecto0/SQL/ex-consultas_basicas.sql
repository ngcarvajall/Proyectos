...
select concat("FirstName", ' ', "LastName") as "Nombre", "Email" 
from "Customer" c 
...
select "Name" "Track_Name", "Milliseconds"/60000.0 as "Duration_Minutes"
from "Track" t 
where "Milliseconds" > 300000
...
select concat("LastName", ' ', "FirstName") as Nombre, "SupportRepId" 
from "Customer" c 
